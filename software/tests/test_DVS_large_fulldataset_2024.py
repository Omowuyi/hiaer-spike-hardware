...
class TestDVSInference:
    ...
    def model_config(self):
        ...
        with open('./fixtures/DVS_model_config_shift=0.pkl', 'rb') as f:
    ...
    def test_dvs_accuracy(self, model_config, test_batch):
        ...
        # Create network
        # Convert shift=0 (2024: no noise) to shift=-17 (L6d: no noise)
        ...
        assert accuracy >= 64.57, f"Expected accuracy is at least 64.57%, but got {accuracy:.2f}%"