...
//    output [22:0]   vio_rx_ptr_ctr,
    ...
    // Spike FIFOs
    input         spk0_full,
    output [18:0] spk0_din,
    output        spk0_wren,

    input         spk1_full,
    output [18:0] spk1_din,
    output        spk1_wren,

    input         spk2_full,
    output [18:0] spk2_din,
    output        spk2_wren,

    input         spk3_full,
    output [18:0] spk3_din,
    output        spk3_wren,

    input         spk4_full,
    output [18:0] spk4_din,
    output        spk4_wren,

    input         spk5_full,
    output [18:0] spk5_din,
    output        spk5_wren,

    input         spk6_full,
    output [18:0] spk6_din,
    output        spk6_wren,

    input         spk7_full,
    output [18:0] spk7_din,
    output        spk7_wren,
...
wire spk_attempt = exec_hbm_rx_phase1_done & exec_hbm_rvalidready_2x;
...
assign spk_dropped =
    (spk_attempt & spk0_full & hbm_rdata[031]) |
    (spk_attempt & spk1_full & hbm_rdata[063]) |
    (spk_attempt & spk2_full & hbm_rdata[095]) |
    (spk_attempt & spk3_full & hbm_rdata[127]) |
    (spk_attempt & spk4_full & hbm_rdata[159]) |
    (spk_attempt & spk5_full & hbm_rdata[191]) |
    (spk_attempt & spk6_full & hbm_rdata[223]) |
    (spk_attempt & spk7_full & hbm_rdata[255]);
